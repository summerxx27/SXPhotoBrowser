...
@implementation CALayer (SXCategory)
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"sxphotobrowser.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"sxphotobrowser.fade"];
}
